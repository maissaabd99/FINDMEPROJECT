 ...
 */
final class Version20201202221308 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE publication ADD non VARCHAR(255) DEFAULT NULL, ADD age INT DEFAULT NULL, ADD sexe VARCHAR(1) DEFAULT NULL, ADD localisation VARCHAR(255) DEFAULT NULL, CHANGE utilisateur_id utilisateur_id INT DEFAULT NULL, CHANGE admin_id admin_id INT DEFAULT NULL, CHANGE date_pub date_pub DATETIME DEFAULT NULL, CHANGE contenu_pub contenu_pub VARCHAR(255) DEFAULT NULL, CHANGE statut statut VARCHAR(1) DEFAULT NULL');
