 ...
 */
final class Version20201223174534 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE administration ADD bloquer TINYINT(1) DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL, DROP bloque, CHANGE password password VARCHAR(255) DEFAULT NULL, CHANGE etat etat VARCHAR(1) DEFAULT NULL, CHANGE username username VARCHAR(255) DEFAULT NULL, CHANGE nom nom VARCHAR(255) DEFAULT NULL, CHANGE prenom prenom VARCHAR(255) DEFAULT NULL, CHANGE tel tel VARCHAR(255) DEFAULT NULL, CHANGE adresse adresse VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE conversation ADD admin_id INT DEFAULT NULL, CHANGE utilisateur_id utilisateur_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE publication ADD longitude VARCHAR(255) DEFAULT NULL, ADD archiver TINYINT(1) DEFAULT NULL, ADD latitude VARCHAR(255) DEFAULT NULL, CHANGE utilisateur_id utilisateur_id INT DEFAULT NULL, CHANGE admin_id admin_id INT DEFAULT NULL, CHANGE date_pub date_pub DATETIME DEFAULT NULL, CHANGE contenu_pub contenu_pub VARCHAR(200) DEFAULT NULL, CHANGE statut statut VARCHAR(1) DEFAULT NULL, CHANGE nom nom VARCHAR(255) DEFAULT NULL, CHANGE age age INT DEFAULT NULL, CHANGE sexe sexe VARCHAR(10) DEFAULT NULL, CHANGE localisation localisation VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE utilisateur CHANGE nom nom VARCHAR(255) DEFAULT NULL, CHANGE prenom prenom VARCHAR(255) DEFAULT NULL, CHANGE adresse adresse VARCHAR(255) DEFAULT NULL, CHANGE tel tel VARCHAR(255) DEFAULT NULL, CHANGE email email VARCHAR(255) DEFAULT NULL, CHANGE username username VARCHAR(255) DEFAULT NULL, CHANGE password password VARCHAR(255) DEFAULT NULL, CHANGE bloque bloque TINYINT(1) DEFAULT NULL, CHANGE verified verified VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE conversation DROP admin_id, CHANGE utilisateur_id utilisateur_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE publication DROP longitude, DROP archiver, DROP latitude, CHANGE utilisateur_id utilisateur_id INT DEFAULT NULL, CHANGE admin_id admin_id INT DEFAULT NULL, CHANGE date_pub date_pub DATETIME DEFAULT \'NULL\', CHANGE contenu_pub contenu_pub VARCHAR(200) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE statut statut VARCHAR(1) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE nom nom VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE age age INT DEFAULT NULL, CHANGE sexe sexe VARCHAR(10) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE localisation localisation VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
